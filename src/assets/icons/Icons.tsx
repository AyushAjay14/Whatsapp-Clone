...
export function MoreOptionsIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" className="sc-gswNZR grTOdA icon">
...
export function OpenStatusIcon() {
  return (
    <svg id="df9d3429-f0ef-48b5-b5eb-f9d27b2deba6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" className="sc-gswNZR grTOdA icon">
...
export function NoNotificationIcon() {
  return (
    <svg viewBox="0 0 48 48" height="48" width="48" preserveAspectRatio="xMidYMid meet" version="1.1" x="0px" y="0px" enableBackground="new 0 0 48 48">
...
export function CloseIcon() {
  return (
    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="1em" className="closeIcon" width="1em" xmlns="http://www.w3.org/2000/svg">
...
export function AttachmentIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" className="attachmentIcon">
...
export function SendButtonIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" className="sendButtonIcon">
